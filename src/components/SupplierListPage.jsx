...
const categoryConfig = {
  ...
  metering:      { icon: Gauge,   color: "#3B82F6", bg: "#EFF6FF" },
  ...
  return (
    <div className="flex flex-wrap items-center gap-1">
      {shown.map((s) => (
        <span
          key={s.id}
          className="text-[10px] font-medium px-1.5 py-0.5 rounded bg-slate-100 text-slate-600 truncate max-w-[140px]"
  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        {/* Summary bar */}
        <div className="flex flex-wrap items-center gap-4 mb-4 text-[12px] text-slate-500">
            ...
            {categoryFilters.map((f) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 h-7 rounded-md text-xs font-medium transition-all whitespace-nowrap ${
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="hidden md:flex items-center gap-4 shrink-0">
                            ...
                            <span className="text-[12px] tabular-nums text-slate-600 font-medium w-[80px] text-right">
                              {fmt(sup.annualSpend)}
                            </span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <div className="text-[13px] font-semibold" style={{ color: brand.navy }}>
                          {sup.name}
                        </div>
                  ...
                  {filtered.map((sup) => {
                    ...
                    return (
                      ...
                      >
                        <td className="px-3 sm:px-4 py-3 max-w-[260px]">
                          <div className="flex items-start gap-2.5">
                            ...
                            <div className="min-w-0">
                              <div className="text-[13px] font-medium truncate" style={{ color: brand.navy }}>
                                {sup.name}
                              </div>
                        ...
                        <td className="px-3 sm:px-4 py-3">
                          <span className="text-[12px] text-slate-600">{sup.city}</span>
                        </td>
                        <td className="px-3 sm:px-4 py-3">
